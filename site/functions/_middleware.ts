// CF Pages Functions middleware for anchor.significanthobbies.com:
...
const SITE_URL = "https://anchor.significanthobbies.com";

const OPENAPI_SPEC = {
  openapi: "3.1.0",
  info: {
    title: "Anchor public API",
    version: "1.0.0",
    description:
      "Anchor is a local-first focus timer for Mac, iPhone and Apple Watch. The public web API exposes read-only agent surfaces: the agent catalog, sitemap, llms.txt, and per-page markdown alternates.",
    contact: { name: "Anchor", url: SITE_URL },
  },
...
\`${path}\` does not exist on anchor.significanthobbies.com.
